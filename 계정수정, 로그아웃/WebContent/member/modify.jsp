        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-12 col-lg-12 mb-12">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister" name="modify" action="modify.do" method="post">
                        <div class="form-row">
                            ...
                            <button type="submit" class="btn hvr-hover" onclick="infoChange()">Register</button>
                    </form>
                </div>
            </div>
        </div>
